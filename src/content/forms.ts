...
const INTAKE_DICTS = {
  en: {
    ...
    /* Clases */
    classesIntro: "Pick one, two or all three. Each extra class is half price.",
    ...
    errPickClass: "Pick at least one class.",
  ...
  es: {
    ...
    classesIntro: "Elige una, dos o las tres. Cada clase que sumes va a mitad de precio.",
    ...
    errPickClass: "Elige al menos una clase.",
