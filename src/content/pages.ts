...
const DICTS = {
  en: {
    ...
    donate: {
      ...
      amounts: [
        { amount: 2_500, buys: "Art supplies for one student, one month." },
        { amount: 5_000, buys: "Supplies for five students." },
        { amount: 10_000, buys: "A full month for a student on scholarship." },
        { amount: 30_000, buys: "A full quarter, materials included." },
      ],
    ...
    store: {
      ...
      title: "Made in a Saturday class.",
      lead: "Every one of these came out of the room. Part of the sale goes to whoever made it.",
      shareLabel: "Part of the sale goes to the student",
      sold: "Sold",
  ...
  es: {
    ...
    donate: {
      ...
      amounts: [
        { amount: 2_500, buys: "Materiales de arte para un estudiante, un mes." },
        { amount: 5_000, buys: "Materiales para cinco estudiantes." },
        { amount: 10_000, buys: "Un mes completo para un estudiante becado." },
        { amount: 30_000, buys: "Un trimestre completo, con materiales." },
      ],
    ...
    store: {
      ...
      title: "Hecho en una clase de sábado.",
      lead: "Cada una salió del salón. Parte de la venta va a quien la hizo.",
      shareLabel: "Parte de la venta va al estudiante",
      sold: "Vendido",
